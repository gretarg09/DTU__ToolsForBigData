...
#video_folder_path = "/Users/helga/Dropbox/Andri/videos"
video_folder_path = "/Users/helga/Dropbox/Andri/more_than_twenty"
###################### FUNCTIONS ###############################
    ...
    for counter, frame in enumerate(reader):
        ...
        if counter < length/divider:
           ...
           # print("width : {}".format(width))
            ...
            image_hash = str(imagehash.average_hash( Image.fromarray(gray), hash_size = 6))        
            frames_lsh.append(image_hash)
...
if __name__ == '__main__':
    ...
    if test_result:        
        ...
        spectral = cluster.SpectralClustering(
                                    ...
                                    affinity="nearest_neighbors", assign_labels = 'discretize', n_jobs = 4).fit(data)
