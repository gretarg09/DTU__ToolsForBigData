# -*- coding: utf-8 -*-
"""
Created on Wed Dec 06 19:39:50 2017
...
if __name__ == "__main__":
    ...
    p = Pool(3)
    results = p.map(multimama, filenames, chunksize = 2)
    ...
    for name, algorithm in clustering_algorithms:
        ...
        try:
            video_and_label = zip(algorithm.labels_, name)
        except:
            # gmm dose not have .labels method
            video_and_label = zip(algorithm.predict(X), name)
